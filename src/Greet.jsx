...
import { VStack, HStack, Button, Input, FormControl, FormLabel } from "@chakra-ui/react";
import * as borsh from 'borsh';
import { PublicKey, Transaction, SystemProgram, TransactionInstruction } from "@solana/web3.js";
import { useWallet, useConnection } from "@solana/wallet-adapter-react";

const programId = new PublicKey("5DTqEpdJ6efjbsotdu1szvpGBPoVZ6KEddUfgVngeHVa");
    ...
    <>
      <VStack width="full" spacing={8} borderRadius={10} borderWidth={2} p={10}>
        <FormControl id="greetings">
          <FormLabel>No. of greetings received</FormLabel>
          <Input 
            type="text" 
